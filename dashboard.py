...
# Load the dataset and select only the first 200 rows
...
dcc.Graph(
    ...
    dcc.Graph(
        id='scatter-lat-lon',
        figure=px.scatter(df, x='longitude', y='latitude', color='neighbourhood_group', title='Scatter Plot of Latitude and Longitude',
                          size='price', hover_data=['neighbourhood', 'price'],
